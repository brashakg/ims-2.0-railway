// ============================================================================
// IMS 2.0 - POS Receipt Preview (v2-4: thermal sales receipt ONLY)
// ============================================================================
// Thermal (80mm) sales receipt with a compact identity header (trade name,
// GSTIN, bill no, amount-in-words, retention-line footer). It is NOT a tax
// invoice and never labels itself one: the statutory tax invoice is the
// SERVER's document (GET /orders/{id}/invoice.pdf), whose serial is minted
// once and recorded. The old "A4 Tax Invoice" fallback tab -- a second
// client-side invoice render -- was retired 2026-09-03 with the GSTInvoice
// modal (owner decision: one invoice document, one number).

import { Printer, Mail, Share2, Download } from 'lucide-react';
      ...
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-screen overflow-y-auto">
        ...
        <div className="no-print bg-white border-b border-gray-200 px-6 py-4 sticky top-0">
          ...
          <p className="text-xs text-gray-500 mt-1">
            Thermal (80mm) sales receipt. For the GST tax invoice use the Tax
            Invoice button — it opens the server-issued document.
          </p>
        </div>

        {/* Receipt Content */}
        <div className="receipt-print-area p-6 receipt-thermal">
          {
            // Thermal Receipt — compact layout (80mm)
            <div
              className="mx-auto"
              style={{
                width: '300px',
            ...
            >
              ...
              {/* Doc strip — always SALES RECEIPT. The statutory TAX INVOICE
                  is the server PDF; two documents claiming that title with
                  different serials is exactly what was retired. */}
              <div
                style={{
                  background: '#1a1a19',
                  color: '#fff',
