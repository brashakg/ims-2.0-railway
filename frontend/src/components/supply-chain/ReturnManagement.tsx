    ...
    <div className="bg-white rounded-lg border border-gray-200">
      ...
      <div className="divide-y divide-gray-200">
        {loading ? (
          ...
          filteredReturns.map(rma => {
            ...
            return (
              <div key={rma.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-semibold text-gray-900">{rma.rmaNumber}</h3>
                    ...
                    <p className="text-sm text-gray-600">Customer: {rma.customerName}</p>
                  </div>
                ...
                {/* Items */}
                <div className="text-sm text-gray-600 mb-3 pl-4 border-l-2 border-gray-200">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowCreateModal(false)}>
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-2xl w-full max-h-96 overflow-y-auto" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <input
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 disabled:opacity-50"
                />
                <input
                  type="text"
