  ...
  if (!isSuperAdmin) {
    return (
      <div className="flex items-center justify-center p-8 bg-white rounded-lg border border-gray-200">
        ...
        <p className="text-gray-600">Only superadmins can manage feature toggles</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {features.map(feature => (
          <div
            key={feature.id}
            className="p-4 bg-white border border-gray-200 rounded-lg flex items-start justify-between hover:border-gray-300 transition"
          >
