      ...
      >
        ...
        <div className="sticky top-0 flex items-center justify-between p-4 border-b border-gray-200 bg-white">
          <div className="flex items-center gap-2">
            ...
            <h2 id="shortcuts-title" className="text-lg font-bold text-gray-900">
              Keyboard Shortcuts
            </h2>
          </div>
          <button
                    ...
                    <div className="flex items-center gap-1">
                      {shortcut.key.split('+').map((key, j) => (
                        <div key={j} className="flex items-center gap-1">
                          ...
                          <kbd className="px-2 py-1 text-xs font-semibold text-gray-900 bg-white border border-gray-200 rounded">
        ...
        <div className="sticky bottom-0 p-4 border-t border-gray-200 bg-white">
          <p className="text-xs text-gray-500">
            Press <kbd className="px-1.5 py-0.5 bg-gray-100 border border-gray-300 rounded text-xs">Escape</kbd> to close
          </p>
        </div>
      </div>
    </div>
