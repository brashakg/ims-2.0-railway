      ...
      <div className="p-6 border-b border-gray-200 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Automate exports, reports, and cleanup</p>
          </div>
        </div>
        <button
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={clsx('text-xs px-2 py-1 rounded', {
                      'bg-green-100 text-green-700': task.enabled,
                      'bg-gray-100 text-gray-700': !task.enabled,
                    })}>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowModal(false)}>
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full" onClick={e => e.stopPropagation()}>
            <h2 className="text-lg font-bold text-gray-900 mb-4">Schedule Task</h2>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    {key.permissions.map(perm => (
                      <span key={perm} className="text-xs px-2 py-1 bg-gray-100 rounded text-gray-700">
                        {perm}
                      </span>
                    ))}
                  </div>
...
export function WebhooksManager({
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-1 mt-2 flex-wrap">
                    {webhook.events.map(event => (
                      <span key={event} className="text-xs px-2 py-1 bg-gray-100 rounded text-gray-700">
                        {event}
                      </span>
                    ))}
                  </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setShowModal(false)}>
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full max-h-96 overflow-y-auto" onClick={e => e.stopPropagation()}>
            <h2 className="text-lg font-bold text-gray-900 mb-4">Create Webhook</h2>
            <div className="space-y-4">
              <input
                type="text"
                value={webhookName}
