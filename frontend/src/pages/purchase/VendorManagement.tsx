  ...
  return (
    <div className="space-y-6">
              ...
              <div key={vendor.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:border-gray-300 transition-colors">
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  <div className="bg-gray-50 border border-gray-200 rounded p-3">
                    <p className="text-gray-500 text-xs mb-1">Delivery Reliability</p>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded p-3">
                    <p className="text-gray-500 text-xs mb-1">Quality Rating</p>
                    <div className="flex items-center gap-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button className="flex-1 px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded text-sm font-semibold flex items-center justify-center gap-1 border border-gray-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {filteredVendors.map((vendor) => (
            <div key={vendor.id} className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-bold text-gray-900 mb-4">{vendor.name}</h3>

              <div className="space-y-3">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-gray-500 text-sm">Delivery Reliability</span>
                    <span className="text-gray-900 font-semibold">{vendor.performance.delivery_reliability.toFixed(1)}/5.0</span>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-gray-500 text-sm">Quality Rating</span>
                    <span className="text-gray-900 font-semibold">{vendor.performance.quality_rating.toFixed(1)}/5.0</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                    <div
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-gray-500 text-sm">Price Competitiveness</span>
                    <span className="text-gray-900 font-semibold">{vendor.performance.price_competitiveness.toFixed(1)}/5.0</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                    <div
                ...
                <div className="pt-3 border-t border-gray-300 space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-900 font-semibold">{vendor.performance.total_pos}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {activeTab === 'contracts' && (
        <div className="space-y-4">
          {vendors.map((vendor) => (
            <div key={vendor.id} className="bg-white border border-gray-200 rounded-lg p-4 flex items-center justify-between">
              <div className="flex-1">
                <h3 className="text-gray-900 font-semibold">{vendor.name}</h3>
                <p className="text-gray-500 text-sm">Expires: {new Date(vendor.contract_expiry).toLocaleDateString()}</p>
              </div>
              <div className="flex items-center gap-3">
