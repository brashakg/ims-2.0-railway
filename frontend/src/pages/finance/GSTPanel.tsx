  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-to-br from-indigo-900 to-indigo-800 border border-indigo-700 rounded-lg p-6 text-gray-900">
        ...
        <div className="bg-gradient-to-br from-violet-900 to-violet-800 border border-violet-700 rounded-lg p-6 text-gray-900">
        ...
        <div className="bg-gradient-to-br from-cyan-900 to-cyan-800 border border-cyan-700 rounded-lg p-6 text-gray-900">
      ...
      <div className="bg-white border border-slate-700 rounded-lg overflow-hidden">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-4 bg-gray-100 rounded border border-slate-600">
