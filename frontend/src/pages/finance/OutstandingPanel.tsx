    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-gradient-to-br from-green-900 to-green-800 border border-green-700 rounded-lg p-6 text-gray-900">
          ...
          <p className="text-xs text-green-700 mt-2">Including tax</p>
        </div>
      </div>
          ...
          <table className="w-full text-sm text-slate-700">
            <thead className="bg-slate-50 border-b border-slate-700">
              <tr>
                ...
                <th className="px-6 py-3 text-right text-slate-600">GST</th>
                <th className="px-6 py-3 text-left text-slate-600">Due Date</th>
                  ...
                  <td className="px-6 py-4 text-center">
                    <span
                      className={clsx(
                        ...
                        item.status === 'overdue'
                          ? 'bg-red-50/50 text-red-700 border border-red-700'
