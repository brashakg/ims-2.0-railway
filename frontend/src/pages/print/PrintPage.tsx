...
const TEMPLATES: PrintTemplate[] = [
  {
    ...
    trigger: { type: 'route', to: '/pos/new', label: 'Open POS → complete a sale → Print from the completion screen' },
    editKey: 'tax_invoice',
    staffHeader: false,
  },
  {
  ...
  },
  {
    ...
    trigger: { type: 'route', to: '/pos/new', label: 'Open POS → finalise sale → Print thermal' },
