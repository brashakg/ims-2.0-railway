...
function KpiCard({
  ...
  return (
    <div
      className={clsx(
        'bg-gray-800 rounded-lg p-4 border shadow-sm',
...
function ModuleCard({
  ...
  return (
    <div
      className="bg-gray-800 rounded-lg p-4 border border-gray-700 shadow-sm cursor-pointer hover:border-bv-gold-300 hover:shadow-md transition-all group"
      onClick={onClick}
    >
      <div
        className={clsx(
      ...
      <h3 className="font-semibold text-white text-sm group-hover:text-bv-gold-600 transition-colors">
        {title}
      </h3>
          ...
          <div className="mb-8 grid grid-cols-2 tablet:grid-cols-4 gap-3">
            {isStaff && <>
              <button onClick={() => navigate('/pos')} className="bg-bv-gold-50 border border-bv-gold-200 rounded-lg p-4 text-left hover:shadow-md transition-all">
                ...
                <p className="text-[10px] text-gray-400">Start a transaction</p>
              </button>
              <button onClick={() => navigate('/orders')} className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-left hover:shadow-md transition-all">
                ...
                <p className="text-[10px] text-gray-400">Track pending orders</p>
              </button>
            </>}
            {isOptometrist && <>
              <button onClick={() => navigate('/clinical')} className="bg-purple-50 border border-purple-200 rounded-lg p-4 text-left hover:shadow-md transition-all">
                ...
                <p className="text-sm font-semibold text-white">Eye Test Queue</p>
                <p className="text-[10px] text-gray-400">Patients waiting</p>
              </button>
              <button onClick={() => navigate('/clinical/prescriptions')} className="bg-green-50 border border-green-200 rounded-lg p-4 text-left hover:shadow-md transition-all">
                ...
                <p className="text-sm font-semibold text-white">Prescriptions</p>
                <p className="text-[10px] text-gray-400">View & create Rx</p>
              </button>
            </>}
          </div>
        )}
