...
def _check_dc_hardlock(db, lens_details, store_id, created_at, current_user, override_reason):
    ...
    """
    lens = lens_details if isinstance(lens_details, dict) else {}
    lens_status = lens.get("lens_status")
