...
class _StockRepo:
    """Serialized stock_units stand-in. `on_create` fires once, BEFORE the very
    first unit is appended -- the tightest possible race window (claim taken,
    nothing minted yet)."""
...
def wired(monkeypatch):
    ...
    def install(grn_doc, repo_cls=_GrnRepo):
